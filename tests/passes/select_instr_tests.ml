...
let test_interp_select_instr _ctxt =
  assert_equal (X0.Interp.interp si1) (Clang.Interp.interp ul1') ~msg:"interp_select_instr: si1" ~printer:string_of_int;
  assert_equal (X0.Interp.interp si2) (Clang.Interp.interp ul2') ~msg:"interp_select_instr: si2" ~printer:string_of_int;
  assert_equal
  ...
  assert_equal (X0.Interp.interp si7) (Clang.Interp.interp ul7') ~msg:"interp_select_instr: si7" ~printer:string_of_int
